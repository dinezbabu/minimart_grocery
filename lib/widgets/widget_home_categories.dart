...
import 'package:minimart_grocery/providers/category_provider.dart';
      ...
      child: Column(
        children: [
         const Padding(padding: const EdgeInsets.all(8),
            child: const Text("All Categories", style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
          ),
...
final categories= ref.watch(categoriesProvider(PaginationModel(page: 1, pageSize: 10)));
